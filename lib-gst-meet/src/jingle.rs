...
impl JingleSession {
  ...
  fn parse_rtp_description(description: &RtpDescription) -> Result<Option<ParsedRtpDescription>> {
  ...
  pub(crate) async fn initiate(conference: &JitsiConference, jingle: Jingle) -> Result<Self> {
    ...
    for content in &jingle.contents {
      if let Some(Description::Rtp(description)) = &content.description {
        if let Some(description) = JingleSession::parse_rtp_description(description)? {
          opus_payload_type = description.opus_payload_type;
          opus_rtcp_fbs = description.opus_rtcp_fbs;
          h264_payload_type = description.h264_payload_type;
          h264_rtx_payload_type = description.h264_rtx_payload_type;
          h264_rtcp_fbs = description.h264_rtcp_fbs;
          vp8_payload_type = description.vp8_payload_type;
          vp8_rtx_payload_type = description.vp8_rtx_payload_type;
          vp8_rtcp_fbs = description.vp8_rtcp_fbs;
          vp9_payload_type = description.vp9_payload_type;
          vp9_rtx_payload_type = description.vp9_rtx_payload_type;
          vp9_rtcp_fbs = description.vp9_rtcp_fbs;
          audio_hdrext_ssrc_audio_level = description.audio_hdrext_ssrc_audio_level;
          audio_hdrext_transport_cc = description.audio_hdrext_transport_cc;
          video_hdrext_abs_send_time = description.video_hdrext_abs_send_time;
          video_hdrext_transport_cc = description.video_hdrext_transport_cc;
          remote_ssrc_map = description.remote_ssrc_map;
        }
      }
